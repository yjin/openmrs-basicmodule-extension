...
import org.openmrs.module.basicmodule.DrugInteraction;
...
@Controller
@RequestMapping(value = "/module/basicmodule/processPrescription.form")
public class PharmDispenseController{
 ...
 public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        return new ModelAndView("module/basicmodule/pharmDispenseReturnPrescriptions", map);
    }
