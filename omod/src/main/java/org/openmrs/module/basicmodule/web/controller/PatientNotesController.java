 ...
 * "org.openmrs.module.basicmodule" into the spring
...
public class PatientNotesController {
	 ...
	 * /openmrs/module/basicmodule/notes.form is visited with EITHER a POST or
	 ...
	 *            in the url
	 */
	@RequestMapping("/module/basicmodule/notes")
...
System.out.println("showNotes in PatientNotesController*****************");
	 ...
	 * element has method="POST"...) on a url like /module/basicmodule/addNote.form .
	 * 
	 * @param patient
	 ...
	 */
	@RequestMapping(value = "/module/basicmodule/addNote", method = RequestMethod.POST)
