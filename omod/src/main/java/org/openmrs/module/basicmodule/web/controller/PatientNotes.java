...
/**
 * This class is found by spring because we put "org.openmrs.module.basicmodule"
 ...
 public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	List<Note> notes = Context.getService(NoteService.class).getNotesByPatient(p);
        ...
        */
        ...
        return new ModelAndView("/module/basicmodule/portlets/patientNotes", map);
    }
    ...
    /**
     * This method is called when the url /openmrs/module/basicmodule/notes.form
     ...
     * /module/basicmodule/addNote.form .
     *
