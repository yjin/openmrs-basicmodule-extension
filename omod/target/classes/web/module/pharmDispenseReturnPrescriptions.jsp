...
<h2><spring:message code="basicmodule.dispenseprescript" /></h2>
...
<a href="/openmrs/admin">Administration</a>
 ...
 -->
			...
			<div id="findPatient">
				...
				<b class="boxHeader" style="padding-left: 15px; padding-right: 15px;"><spring:message code="basicmodule.findpatient" /></b>
				<div class="box" style="padding: 15px 15px 15px 15px;">
					
                                    <b><spring:message code="basicmodule.findpatient" /></b>
