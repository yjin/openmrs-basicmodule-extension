...
<!--
 ...
 -->
            <a href="pharmDispenseReturnPrescriptions.htm"><spring:message code="basicmodule.pres" /></a> 
	</li>
        ...
        <li>
            <a href="pharmDispenseReturnPrescriptions.htm"><spring:message code="basicmodule.invmgmt" /></a>
        </li>
        <li>
